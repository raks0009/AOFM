...
bcd1029LB 1 - | - 	bcd1030	; 	/* ; clk!=1; */
bcd1030 2 clk!=1 | - 	bcd1031	 !(clk!=1) | - 	bcd1032LE	; 	
bcd1031 1 - | - 	bcd1030	; 	
bcd1032LE 1 - | eop=0	bcd1987	; 	/* loop_end */
...
bcd1042LB 1 - | - 	bcd1043	; 	/* ; clk!=1; */
bcd1043 2 clk!=1 | - 	bcd1044	 !(clk!=1) | - 	bcd1045LE	; 	
bcd1044 1 - | - 	bcd1043	; 	
bcd1045LE 1 - | eop=0	bcd1985	; 	/* loop_end */
...
bcd1061LB 1 - | - 	bcd1062	; 	/* ; clk!=1; */
bcd1062 2 clk!=1 | - 	bcd1063	 !(clk!=1) | - 	bcd1064LE	; 	
bcd1063 1 - | - 	bcd1062	; 	
bcd1064LE 1 - | eop=0	bcd1973	; 	/* loop_end */
bcd1065 1 - | eop=1	bcd1066	; 	
bcd1066 1 - | BREAK=1	bcd1972	; 	
bcd1067 1 - | BREAK=1	bcd1969	; 	
bcd1966LE 1 - | - 	bcd1968	; 	/* loop_end */
bcd1967LB 1 - | - 	bcd1968	; 	/* ; start!=0; */
bcd1968 2 - | - 	bcd1996LB	 !() | - 	bcd1068LE	; 	
bcd1969 1 - | - 	bcd1971	; 	
bcd1970LB 1 - | - 	bcd1971	; 	/* ; start!=0; */
...
bcd1974LE 2 eop==1 | - 	bcd1058	 !(eop==1) | - 	bcd1059	; 	/* loop_end */
bcd1975 1 - | - 	bcd1977	; 	
bcd1976LB 1 - | - 	bcd1977	; 	/* ; (actnum!=num) && (white!=255); */
bcd1977 2 (actnum!=num) && (white!=255) | - 	bcd1990LB	 !((actnum!=num) && (white!=255)) | - 	bcd1974LE	; 	
bcd1978LE 2 eop==1 | - 	bcd1057	 !(eop==1) | - 	bcd1975	; 	/* loop_end */
bcd1979 1 - | - 	bcd1981	; 	
bcd1980LB 1 - | - 	bcd1981	; 	/* ; (white!=255) || (black!=255); */
...
bcd1988LE 2 eop==1 | - 	bcd1023	 !(eop==1) | - 	bcd1024	; 	/* loop_end */
bcd1989 1 - | - 	bcd1991	; 	
bcd1990LB 1 - | - 	bcd1991	; 	/* ; clk!=1; */
bcd1991 2 - | - 	bcd1016LB	 !() | - 	bcd1988LE	; 	
bcd1992 2 scan==1 | - 	bcd1022	 !(scan==1) | - 	bcd1989	; 	
bcd1993 2 reset==1 | - 	bcd1020	 !(reset==1) | - 	bcd1992	; 	
bcd1994LE 2 eop==1 | - 	bcd1015	 !(eop==1) | - 	bcd1976LB	; 	/* loop_end */
bcd1995 1 - | - 	bcd1997	; 	
bcd1996LB 1 - | - 	bcd1997	; 	/* ; clk!=1; */
