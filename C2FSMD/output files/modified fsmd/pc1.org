...
q1987LE 1 - | bit_no=bit_no+1	q1989	; 	/* loop_end */
q1988LELB 1 - | bit_no=0	q1989	; 	/* loop_end *//* bit_no=0,; bit_no<8; bit_no=bit_no+1, */
q1989 2 bit_no<8 | - 	q1991LB	 !(bit_no<8) | - 	q1008LE	; 	o+1, */
q1990LE 1 - | i=i+1	q1992	; 	/* loop_end */
q1991LB 1 - | i=0	q1992	; 	/* i=0,; i<leftShift(1,8); i=i+1, */
